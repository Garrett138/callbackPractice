...
function multiply(four, three, answer) {
  answer(four * three);
}
...
// If it does, return true using the callback, if not return false.
  ...
  function contains(names, colt, fun) {
    fun(names.includes(colt));
...
/*function uniq(names, fun) {
var others = [];
fun(names.includes(others));
...
// and returns that user.
 ...
 function getUserById(users, num, fun) {
   for (num in users) {
      fun(users[num])
   }
